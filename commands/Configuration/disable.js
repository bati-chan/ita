...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!selection) return message.channel.send(errorEmbed.setColor("#F51B00").setDescription(`❌ **| You must specify a function to disable!**`)).then(m => m.delete(5000));
    ...
    else return message.channel.send(errorEmbed.setColor("#F51B00").setDescription(`❌ **| You must specify a valid function to disable!**`)).then(m => m.delete(5000));
